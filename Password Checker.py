...
def suggestions(text):
    ...
    # check for symbol
        ...
        if symbol_found == True:
            ...
            suggestion_group2.append('missing a symbol (!,@,#,$,?)')
            suggestions2_amount += 1
    ...
    # check for number
        ...
        if number_found == True:
            ...
            suggestion_group2.append('missing a number')
            suggestions2_amount += 1
    ...
    # breached, dictionary words, only spaces and common passwords result in a 0 score
        ...
        if suggestions2_amount >= 1:
            suggestion2.text = f'Password is: {suggestion_words2}'
        else:
            suggestion2.text = ''
...
suggestions_name = gp.StyleLabel(app, "Feedback:")
